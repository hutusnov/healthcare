...
const DEFAULT_OCR_URLS = [
  'http://192.168.100.169:30081',
  'http://192.168.100.169:30082',
  'http://192.168.100.169:8001',
];
...
function getOcrUrls() {
  ...
  const configured = raw
    ...
    .filter(Boolean);
  return configured.length > 0 ? configured : DEFAULT_OCR_URLS;
}

...
- `deploy/aws-monitoring`: monitoring and logging stack for the hybrid runtime.
- `deploy/aws-public-edge`: Route 53 / CloudFront / WAF scaffolding for the target public edge.
